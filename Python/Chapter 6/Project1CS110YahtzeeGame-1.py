...
score1 = 0
score2 = 0
#open/create the highscore file
f = open("highScore.txt","a")
f.close()
#open the file to read
f = open("highScore.txt","r")
#check if there is currently any highscore
y = f.readline()
x = f.readline()
#if no highscore exists, tell the player there is no highscore
if y == "":
    print("No Current Highscore")
    x = 0
#otherwise print the record-holder's name and score
else:
    print("Highscore: " + str(y) + str(x))
#ask them to press enter to continue
...
if int(final) > int(x):
    ...
    hsname = input("New Highscore! Please input your name ")
    #clear the file
    f.truncate(0)
